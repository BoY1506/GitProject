 ...
 */
public class MyRefreshLayout extends RelativeLayout implements SwipeRefreshLayout.OnRefreshListener, AbsListView.OnScrollListener {
    ...
    private void initView() {
        ...
        refreshLayout.setLayoutParams(new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT,
                RelativeLayout.LayoutParams.MATCH_PARENT));
        refreshLayout.setColorSchemeColors(Color.RED);
        refreshLayout.setOnRefreshListener(this);
        //初始化listView（用户在xml文件中自定义空布局）
        listView = (ListView) UIUtils.inflate(getContext(), R.layout.view_common_list);
        ...
        footerView.setLayoutParams(new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
    ...
    public void onRefresh() {
        //当前没有加载任务才刷新
        if (!isLoadData && refreshListener != null) {
            page = 1;
            //开始请求数据
            isLoadData = true;
