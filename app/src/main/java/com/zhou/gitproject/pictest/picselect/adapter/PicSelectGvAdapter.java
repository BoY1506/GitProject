 ...
 */
public class PicSelectGvAdapter extends BaseAdapter {
    ...
    public PicSelectGvAdapter(Context context, List<Uri> data, GridView gridView) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = UIUtils.inflate(context, R.layout.item_pics_gv);
        ...
        //测量item的宽度
        int itemWidth = (gv.getWidth() - gv.getHorizontalSpacing() * 2 - gv.getPaddingLeft() - gv.getPaddingRight()) / 3;
        //为每个item设置大小
