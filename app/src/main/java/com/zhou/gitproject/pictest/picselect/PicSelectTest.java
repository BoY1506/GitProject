...
import com.zhou.gitproject.pictest.picselect.adapter.PicSelectGvAdapter;
import com.zhou.gitproject.pictest.picselect.utils.PhotoUtils;
...
public class PicSelectTest extends BaseActivity {
    ...
    //画廊适配器
    private PicSelectGvAdapter adapter;
    //用于传递照片list
    ...
    private void initView() {
        adapter = new PicSelectGvAdapter(this, picUriList, picGv);
        ...
        if (resultCode == RESULT_CANCELED) {
            ...
            switch (requestCode) {
                case PhotoUtils.CAMERA_REQUEST_CODE:
                    //拍照
                    adapter.addPic(PhotoUtils.saveBitmap(PhotoUtils.getSmallBitmap(this, null), PhotoUtils.getPicName()));
                    break;
                case PhotoUtils.GALLERY_REQUEST_CODE:
                    ...
                    if (data == null) {
                        ...
                        adapter.addPic(PhotoUtils.saveBitmap(PhotoUtils.getSmallBitmap(this, uri), PhotoUtils.getPicName()));
                    }
                    break;
            }
        }
