 ...
 * 关于GestureLockViewGroup的边长（n*n）： n * mGestureLockViewWidth + ( n + 1 ) * mMarginBetweenLockView = mWidth ;
...
//            mPaint.setStrokeWidth(mGestureLockViewWidth * 0.3F);
            mPaint.setStrokeWidth(2 * 2);
...
//                mPaint.setAlpha(50);
                ...
                if (mOnGestureLockViewListener != null && mChoose.size() > 0) {
                    ...
                    mOnGestureLockViewListener.onGetSelectNumbers(sb.toString());
                    if (this.mTryTimes == 0) {
...
//    }
    ...
    private boolean checkPositionInChild(View child, int x, int y) {
        ...
        //可以通过调整padding使得x,y落入范围改变，或者不设置padding
...
//    }
    ...
    public interface OnGestureLockViewListener {
         ...
         * @param numbers
         */
        void onGetSelectNumbers(String numbers);
