...
/**
 * 自定义viewpagerTitle+指示器
 * Created by zhou on 2016/8/16.
 */
public class MyPagerIndicator extends LinearLayout implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    private void initViews() {
        ...
        tvLl.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, 0, 1));
    ...
    public void setTvNum(int num) {
        ...
        underLine.setLayoutParams(new LinearLayout.LayoutParams(underLineWidth, UIUtils.dp2px(getContext(), 3f)));
    }
    ...
    public void onPageSelected(int position) {
        ...
        if (pager != null && pager.getAdapter() != null) {
            ((MyLoadFragment) ((FragmentPagerAdapter) pager.getAdapter()).getItem(position)).firstRequest();
        }
    }
