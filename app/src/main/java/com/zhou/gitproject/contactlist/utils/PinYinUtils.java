...
public class PinYinUtils {
    ...
    private static String[] pystr = new String[]{"a", "ai", "an", "ang",
            ...
            "zao", "ze", "zei", "zen", "zeng", "zha", "zhai", "zhan", "chang",
            "zhao", "zhe", "zhen", "zheng", "zhi", "chong", "zhou", "zhu",
