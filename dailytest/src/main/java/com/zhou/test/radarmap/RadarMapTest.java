package com.zhou.test.radarmap;
...
import com.zhou.test.radarmap.adapter.MyPagerAdapter;
import com.zhou.test.radarmap.been.Info;
import com.zhou.test.radarmap.utils.FixedSpeedScroller;
import com.zhou.test.radarmap.utils.LogUtil;
import com.zhou.test.radarmap.utils.ZoomOutPageTransformer;
import com.zhou.test.radarmap.view.CustomViewPager;
import com.zhou.test.radarmap.view.RadarViewGroup;
 ...
 */
public class RadarMapTest extends Activity implements ViewPager.OnPageChangeListener, RadarViewGroup.IRadarClickListener {
...
//            R.drawable.mnj, R.drawable.leo, R.drawable.leq, R.drawable.les, R.drawable.lep, R.drawable.len,
//            R.drawable.leo, R.drawable.lep, R.drawable.ler, R.drawable.les, R.drawable.mln};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_radarmap_test);
        initView();
        initData();
        ...
        final MyPagerAdapter mAdapter = new MyPagerAdapter(this, viewPager);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                radarViewGroup.setPagerAdapter(mAdapter);
            }
        }, 1500);
    ...
    private void setViewPagerSpeed(int duration) {
        try {
            ...
            scroller = new FixedSpeedScroller(RadarMapTest.this, new AccelerateInterpolator());
...
//            //设置一大堆演示用的数据，麻里麻烦~~
//            BottomBarView view = LayoutInflater.from(RadarMapTest.this).inflate(R.layout.viewpager_layout, null);
...
//            }
//            ivPortrait.setOnClickListener(new BottomBarView.OnClickListener() {
//                @Override
//                public void onClick(BottomBarView v) {
//                    Toast.makeText(RadarMapTest.this, "这是 " + info.getName() + " >.<", Toast.LENGTH_SHORT).show();
//                }
//            });
...
//
//        @Override
//        public boolean isViewFromObject(BottomBarView view, Object object) {
//            return view == object;
//        }
//
//        @Override
//        public void destroyItem(ViewGroup container, int position, Object object) {
//            BottomBarView view = (BottomBarView) object;
